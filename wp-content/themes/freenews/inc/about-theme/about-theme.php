	...
	<div class="col-left">
		<div class="intro">
			<h3><?php /* translators: %s theme name */
				...
				?></p>
				<p> &nbsp;</p>
				<a href="<?php echo esc_url('https://demo.themefreesia.com/freenews'); ?>" class="button button-primary button-hero about-theme" target="_blank"><?php esc_html_e( 'Visit Free Demo', 'freenews' ); ?></a><a href="<?php echo esc_url('https://demo.themefreesia.com/freenews-pro'); ?>" class="button button-primary button-hero about-theme" target="_blank"><?php esc_html_e( 'Visit Plus Demo', 'freenews' ); ?></a>
		</div>
		<div class="theme-tabs">
			...
			<label for="five" class="tab-label"><?php esc_html_e('Plus Features','freenews');?></label>

			<article class="content one">
			    <h3><?php esc_html_e('About Documentation','freenews');?></h3>
			    <p><?php esc_html_e('Documentation is the information that describes the product to its users. Our documentation covers only related to Free Themes and Plus Extension Plugins. It will guide your to develop your Website as we displayed in demo site without any others help.','freenews');?></p>
			    <p>
					<a href="<?php echo esc_url('https://themefreesia.com/theme-instruction/freenews/');?>" target="_blank" class="button button-primary"><?php printf( esc_html__( '%s Documentation', 'freenews' ), esc_html( $theme->Name ) ); ?></a>
				</p>
			   ...
			   <p><?php esc_html_e('Want to know more about Themes and Plugins developed by Theme Freesia? ','freenews'); ?><a href="<?php echo esc_url('https://themefreesia.com/frequently-asked-questions/');?>" class="button button-primary" target="_blank"><?php esc_html_e('F.A.Q','freenews');?></a></p>
			...
			<article class="content two">
				...
				<p>
					<?php esc_html_e( 'If your site have your own content then do not use this plugins. It will mess your site with dummy content. Is your site fresh? Install the Demo importer plugins and activate it.', 'freenews' ); ?></p>
				<p><?php esc_html_e('Do you want to import Demo Data? ','freenews'); ?></p>
					<p>
					<a href="https://themefreesia.com/theme-freesia-demo-import/" target="_blank" class="button button-primary" style="text-decoration: none;">
						<?php esc_html_e( 'Download Dummy Plugin', 'freenews' ); ?>
					</a>
				&nbsp;&nbsp;
			...
			<article class="content three">
			   <h3><?php esc_html_e('About Support','freenews');?></h3>
				<p><?php esc_html_e('Need Help? Use our Forums if you have any Themes and Plugins related questions. Support will be provided only related to our Themes and Plugins','freenews');?>
					<a href="<?php echo esc_url('https://themefreesia.com/support-forum/'); ?>" target="_blank" class="button button-primary"> <?php esc_html_e('Plus Forum','freenews');?></a> <a href="<?php echo esc_url('https://tickets.themefreesia.com/'); ?>" target="_blank" class="button button-primary"> <?php esc_html_e('Free Tickets','freenews');?></a>
				</p>
				...
				<p><?php esc_html_e('Do you have discussion relating to billing, your account or have pre-sales questions? Get touch with us!','freenews');?>
					<a href="<?php echo esc_url('https://themefreesia.com/contact-us/');?>" target="_blank" class="button button-primary"> <?php esc_html_e('Contact us','freenews');?></a>
				</p>
			   <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/screenshot.jpg">
			</article>
			...
			<article class="content five">
				 <h3><?php esc_html_e('Upgrade to Plus','freenews');?></h3>
				 <p><?php esc_html_e('Want additional features? Plus extension plugin adds additinal features for free themes. ','freenews')?><a href="<?php echo esc_url('https://themefreesia.com/themes/freenews');?>" class="button button-primary button-hero" target="_blank"><?php esc_html_e('Upgrade to Plus','freenews');?></a></p>
			   <h3><?php esc_html_e('Plus Features Extension','freenews');?></h3>
		...
		<div class="pro-content">
			<div class="pro-content-wrap">
				<div class="pro-content-header">
					<h3><?php esc_html_e('Powerful Plus Extension Features','freenews');?></h3>
					<p><?php esc_html_e('Get unlimited features using Plus extension. Purchase FreeNews Plus extension and get additional features and advanced customization options to make your website look awesome in different styles. ','freenews'); ?></p>
				</div>
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/free_vs_pro.png" alt="<?php esc_attr_e('Free vs Plus','freenews');?>">
			</div>
		</div>
	</div>
</div>
